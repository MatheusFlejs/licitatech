...
def enviar_para_gemini(caminho_pdf):
    try:
        prompt = (
            ...
            "Data do edital, número do edital, data de abertura das propostas, data de fechamento das propostas, funcionamento detalhado dos prazos da fase de lances(tempo da etapa aberta e tempo da etapa fechada), validade da proposta, vigencia do contrato, órgão responsável, objeto da contratação, modalidade, prazo, itens principais."
...
def executar_pipeline():
    ...
    caminho = "C:\\Users\\m11967419990\\Desktop\\MVP\\pdfs\\arquivo1.pdf"
    resumos_gerados = []
    ...
    try:
        ...
        salvar_json(resumo_json, contador=1)
        nome_html = gerar_html_bruto_formatado(resumo_json, contador=1)
        if nome_html:
            resumos_gerados.append(nome_html)
